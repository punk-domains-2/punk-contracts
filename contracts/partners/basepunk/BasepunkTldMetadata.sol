...
contract BasepunkTldMetadata is Ownable {
  string public description = "The official web3 name and digital identity of the BasePunk NFT community.";
  string public brand = "https://id.basepunk.xyz";
  ...
  function _getImage(string memory _fullDomainName) internal view returns (string memory) {
    string memory svgBase64Encoded = Base64.encode(bytes(string(abi.encodePacked(
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="500" height="500">',
        ...
        '<stop offset="0%" style="stop-color:#135247;stop-opacity:1" />',
        '<stop offset="100%" style="stop-color:#210B4D;stop-opacity:1" /></linearGradient></defs>',
